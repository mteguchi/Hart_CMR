...
This document describes data analysis of Catherine Hart's data of hawksbill turtle capture recapture events. In this version, we use community (sampling site) specific data for estimating survival/capture probability, and derived abundance using CJS models. 
...
community.names <- levels(dat.1$community)
